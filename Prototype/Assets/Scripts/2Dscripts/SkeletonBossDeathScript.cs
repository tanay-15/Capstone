...
using UnityEngine;
public class SkeletonBossDeathScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        mhealth = this.gameObject.GetComponent<BossPhaseOne>().GetHealth();
    ...
    IEnumerator Initialize()
    {
        ...
        Debug.Log("Assembling the boss");
        GetComponent<BossPhaseOne>().enabled = true;
